...
const services: Service[] = [
  ...
  },
  {
    ...
    details: {
      ...
      fullDescription: "\"Зэт Ди Эн Смарт Энержи\" ХХК нь 2023 оноос газрын тос, газрын тосны бүтээгдэхүүнийг MNS ISO/IЕС 17025-2018 стандартаар баталгаажсан арга, дээжний тоног төхөөрөмжөөр чанарын шинжилгээ хийж эхэлсэн. Үүнтэй зэрэгцүүлэн MNS ISO/IEC 17020-2013 стандартын нэрвүүлэн тооны хяналтын албыг байгуулж, ҮИТ-аас итгэмжлэгдсэн.",
      serviceScope: [
